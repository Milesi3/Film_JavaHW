...
public class RentFilm {
    ...
    public void setServiceAdmin(People serviceAdmin) {
    ...
    public RentFilm createRentFilm(ArrayList <People> pb, ArrayList <Film> fb, People admin) {
    ...
    public void fillRecord(ArrayList<RentFilm> record, ArrayList <People> pb, ArrayList <Film> fb, People admin) {
        boolean flag = true;
                while (flag) {
    ...
    public ArrayList<RentFilm>  inputFile(String filename, ArrayList <People> pb) throws IOException {
        String[] parsing;
